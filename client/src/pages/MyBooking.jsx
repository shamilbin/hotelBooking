        ...
        {bookings.map((booking) => (
          ...
          >
            ...
            <div className="flex flex-col items-start justify-center pt-3">
                ...
                {!booking.isPaid &&(
                    <button className="px-4 py-1.5 mt-4 text-sm border bg-gray-200 hover:border-2 hover:border-green-900  border-gray-400 hover:scale-95 rounded-full hover:bg-green-500 transition-all cursor-pointer">
                        Pay Now
                    </button>
                )}
