  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mt-20">
        <p className="bg-[#49B9FF]/50 px-4 py-1 rounded-full text-sm md:text-base inline-block">
          The Ultimate Hotel Experience
        </p>

        <h1 className="font-playfair text-3xl md:text-5xl lg:text-[56px] leading-tight font-bold max-w-xl mt-4">
          Discover Your Perfect Getaway Destination
        </h1>

        <p className="max-w-lg mt-3 text-sm md:text-base text-gray-200">
          Unparalleled luxury and comfort await at the world's most exclusive
          hotels and restaurants. Start your journey today.
        </p>
        <form className="bg-white text-gray-500 rounded-lg px-6 py-4 mt-8 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto">
          ...
          <button className="flex items-center justify-center gap-1 rounded-md bg-black py-3 px-4 text-white my-auto cursor-pointer max-md:w-full max-md:py-1">
            <img src={assets.searchIcon} alt="calender" className="h-7 " />
            <span>Search</span>
          </button>
        </form>
      </div>
